  ...
  return (
    <ComponentSection
      ...
      >
        ...
        <Example title="As child" description="Renders a Next.js Link styled as a button.">
          <Button asChild>
            <Link href="/design-system">Go to design system</Link>
          </Button>
          <Button asChild variant="outline">
            <Link href="/design-system">Outline link</Link>
          </Button>
        </Example>
