...
function CardTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'font-sans text-2xl font-semibold group-data-[size=sm]/card:text-sm',
        className
      )}
      {...props}
    />
...
function CardFooter({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'bg-neutral-100 flex items-center rounded-b-xl border-t border-border p-(--card-spacing) dark:bg-neutral-800',
        className
      )}
      {...props}
    />
