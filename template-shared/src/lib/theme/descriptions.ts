...
const SEMANTIC_DESCRIPTIONS: Record<string, string> = {
  ...
  'destructive-foreground': 'Text/icon color placed on top of the destructive color.',
  success: 'Color used for success states and positive confirmation.',
  'success-foreground': 'Text/icon color placed on top of the success color.',
  warning: 'Color used for warning states and cautionary callouts.',
  'warning-foreground': 'Text/icon color placed on top of the warning color.',
  info: 'Color used for informational states and neutral callouts.',
  'info-foreground': 'Text/icon color placed on top of the info color.',
  ...
  'shadow-xs': 'Box shadow used for the lightest elevation (extra-small).',
